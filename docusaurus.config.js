    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/maryamkhanzada/Hackathon_project_1/tree/main/',
        },
        blog: false, // Disable blog feature for this book
        theme: {
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/maryamkhanzada/Hackathon_project_1',
            label: 'GitHub',
            position: 'right',
          },
        ],
